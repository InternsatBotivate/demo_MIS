      ...
      <div className="flex min-h-screen">
                ...
                <div className="mt-4 sm:mt-6">
                  ...
                  <div className="mt-4 grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4 text-sm">
                    ...
                    <div className="bg-gray-50 p-3 rounded-lg border border-gray-200">
                      ...
                      <p className="text-gray-600 text-xs sm:text-sm">Username: user</p>
                      <p className="text-gray-600 text-xs sm:text-sm">Password: user123</p>
                    </div>
                  </div>
                </div>
              </form>
        ...
        <div className="hidden lg:flex w-1/2 bg-gradient-to-br from-blue-600 via-blue-700 to-indigo-800 p-8 relative overflow-hidden">
          ...
          <div className="w-full flex flex-col justify-center text-white">
            <h2 className="text-3xl lg:text-4xl font-bold mb-8 leading-tight">Streamline Your Workflow</h2>
            <div className="space-y-6 lg:space-y-8">
              <div className="flex items-start space-x-4 group">
                ...
                <div>
                  <h3 className="text-lg lg:text-xl font-semibold mb-2">Real-time Analytics</h3>
                  <p className="text-blue-100 leading-relaxed">Track performance metrics and team progress with intuitive dashboards</p>
                </div>
              </div>
              <div className="flex items-start space-x-4 group">
                <div className="w-10 h-10 rounded-full bg-white/20 flex items-center justify-center shrink-0 group-hover:bg-white/30 transition-colors">
                ...
                <div>
                  <h3 className="text-lg lg:text-xl font-semibold mb-2">Task Management</h3>
                  <p className="text-blue-100 leading-relaxed">Efficiently manage and track tasks across your organization</p>
                </div>
              </div>
              <div className="flex items-start space-x-4 group">
                <div className="w-10 h-10 rounded-full bg-white/20 flex items-center justify-center shrink-0 group-hover:bg-white/30 transition-colors">
                ...
                <div>
                  <h3 className="text-lg lg:text-xl font-semibold mb-2">Performance Tracking</h3>
                  <p className="text-blue-100 leading-relaxed">Monitor employee performance and productivity metrics</p>
                </div>
              </div>
            </div>
          </div>
